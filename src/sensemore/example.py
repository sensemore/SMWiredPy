...
# mac = self.get_available_devices()[0]
# accelerometer_range = "16G"
# sampling_frequency = 12800
# sample_size = 100

# measurement_result = self.measure(mac,accelerometer_range,sampling_frequency,sample_size)
...
telems = wired_network.get_all_telemetry(mac)
print(telems)
